...
import { ChatFeedItem, FrontendJobSnapshot } from '../../types/apiContracts';
...
export const MessageFeed: React.FC = () => {
  ...
  const anchoredJobs = new Map<string, FrontendJobSnapshot[]>();
  const trailingJobs: FrontendJobSnapshot[] = [];
