...
import { TemplateDocumentSummary, TemplateJobSnapshot, TemplateMetaSummary } from '../../types/apiContracts';
...
export const TemplateWorkspace: React.FC = () => {
  ...
  const [configs, setConfigs] = useState<TemplateMetaSummary[]>([]);
  const [selectedTemplatePath, setSelectedTemplatePath] = useState('');
  const [document, setDocument] = useState<TemplateDocumentSummary | null>(null);
